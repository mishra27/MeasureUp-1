...
public class VideoRecorder {
    ...
    public void setEglConfig(android.opengl.EGLConfig eglConfig) {
    ...
    public static class CaptureContext {
        android.opengl.EGLDisplay windowDisplay;
        android.opengl.EGLSurface windowReadSurface;
        android.opengl.EGLSurface windowDrawSurface;
        private int mWidth;
        private int mHeight;
